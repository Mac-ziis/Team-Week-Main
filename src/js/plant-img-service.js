export default class PlantImgService {
  static getPlantByImage(plantImage) {
    return fetch (`https://my-api.plantnet.org/v2/identify/all?images=${plantImage}&organs=leaf&include-related-images=true&no-reject=true&lang=en&type=kt&api-key=2b10LbNjTTDY88wEIWjTGFW`, {method: 'GET', headers: {'Content-Type': 'application/json'}})
